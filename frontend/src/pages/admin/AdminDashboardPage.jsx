...
export function AdminDashboardPage({ onNavigate = noopNavigate }) {
  const { loading, errorMessage, metrics, recentActivities } = useAdminDashboardData();
  ...
  const quickActions = [
    ...
    {
      title: 'Terima Sampel & Cetak Barcode',
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-semibold text-gray-900">Dashboard Admin</h1>
          <p className="text-gray-600">Ringkasan status permohonan dan pengujian sampel</p>
