      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        <div className="relative mb-4">
          ...
          <input
            ...
            placeholder={activeTab === 'staff' ? 'Cari nama, NIK, jabatan, email, username, atau role...' : 'Cari pelanggan, PIC, email, atau status akun...'}
      ...
      <table className="w-full min-w-[920px]">
        ...
        <tbody>
          {rows.map((row) => {
            ...
            return (
              <tr key={row.nik || row.id_pegawai || row.id} className="border-b border-gray-100 hover:bg-gray-50">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Jabatan: {dash(row.jabatan || row.position)}</p>
                      <p className="text-xs text-gray-500">Username: {dash(row.username)}</p>
                    </div>
                  </div>
                </td>
