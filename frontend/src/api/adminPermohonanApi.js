...
export const adminPermohonanApi = {
  ...
  verifyPayment(idRegistrasi, body) {
    return jsonRequest(`/requests/${idRegistrasi}/payment/verify`, 'POST', body);
  },

  generateFppl(idRegistrasi) {
    return jsonRequest(`/requests/${idRegistrasi}/fppl/generate`, 'POST', {});
  },
