...
export function AdminPermohonanDetailView({
  ...
  onBackToList,
    ...
    const showFpplDocumentSection = !isStoppedRequest && Boolean(selectedRequest?.nomor_fppl || selectedRequest?.nomorFppl || selectedRequest?.file_fppl || selectedRequest?.fileFppl || paymentIsCleared);
