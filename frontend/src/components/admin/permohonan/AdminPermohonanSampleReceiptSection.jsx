...
export function AdminPermohonanSampleReceiptSection({
  ...
  const sampleReceiptInfoMessage = (() => {
    ...
    if (normalizedStatus !== FPPL_STATUSES.MENUNGGU_SAMPEL) {
      return 'Penerimaan sampel hanya tersedia saat status permohonan Menunggu Sampel.';
    }
            ...
            <>
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                <p className="text-sm font-medium text-blue-800">
                  Isi data kondisi, acuan, lokasi spesifik, koordinat, dan tanggal pengambilan. Tanggal/jam penerimaan dicatat otomatis saat generate nomor sampel dan barcode.
                </p>
              </div>
              ...
              >
                ...
                {saving ? 'Generate Nomor Sampel...' : 'Generate Nomor Sampel & Barcode'}
              </button>
            </>
          ) : (
