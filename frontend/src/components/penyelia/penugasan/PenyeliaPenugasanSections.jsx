  ...
  const metrics = [
    {
      ...
      iconBg: 'bg-blue-50',
      actionLabel: 'Buka daftar butuh penugasan',
      onClick: () => onSelectTab?.('buat'),
    },
    {
      ...
      iconBg: 'bg-red-50',
      actionLabel: 'Buka sampel belum ditugaskan',
      onClick: () => onSelectTab?.('buat'),
    },
    {
      ...
      iconBg: 'bg-violet-50',
      actionLabel: 'Buka monitoring penugasan aktif',
    ...
    },
    {
      ...
      iconBg: 'bg-amber-50',
      actionLabel: 'Buka hasil subkontrak',
      onClick: () => onSelectTab?.('subkontrak'),
    },
  ];
