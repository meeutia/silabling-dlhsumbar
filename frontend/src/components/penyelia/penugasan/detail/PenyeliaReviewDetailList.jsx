...
function PenyeliaReviewSamplesTable({
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full min-w-[2140px] table-fixed">
        <thead className="border-b border-gray-200 bg-white">
          <tr>
            ...
            <th className="w-[580px] px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-700">
              Catatan Revisi
            </th>
          </tr>
        </thead>
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3 align-top">
                    <span
                      className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold ${getStatusClass(rowStatus)}`}
                    >
                      {rowStatus}
                    </span>
                  </td>

                  <td className="w-[580px] px-4 py-3 text-sm text-gray-700 align-top">
                    {penyeliaRevisionNote || kasiRevisionNote || penyeliaResponseNote ? (
                      <div className="space-y-2">
                        {penyeliaRevisionNote && (
                          <div className="w-full whitespace-pre-wrap rounded-lg border border-red-200 bg-red-50 p-2 text-xs text-red-700">
                        ...
                        {kasiRevisionNote && (
                          <button
                            ...
                            className={`block w-full whitespace-pre-wrap rounded-lg border border-amber-200 bg-amber-50 p-2 text-left text-xs text-amber-700 transition-all ${
                        ...
                        {penyeliaResponseNote && (
                          <div className="w-full whitespace-pre-wrap rounded-lg border border-sky-200 bg-sky-50 p-2 text-xs text-sky-700">
