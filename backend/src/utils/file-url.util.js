...
const SCOPE_BY_PREFIX = [
  ...
  { prefix: '/fppl/', scope: 'fppl', route: '/files/fppl' },
  { prefix: '/uploads/bukti-bayar/', scope: 'payment', route: '/files/payment' },
  { prefix: '/bukti-bayar/', scope: 'payment', route: '/files/payment' },
];
...
function secureKnownFileFields(value) {
  ...
  const fieldPairs = [
    ...
    ['bukti_bayar_path', 'bukti_bayar_original_path'],
    ['buktiBayarPath', 'buktiBayarOriginalPath'],
    ['file_invoice_path', 'file_invoice_original_path'],
    ['fileInvoicePath', 'fileInvoiceOriginalPath'],
    ['file_fppl', 'file_fppl_original_path'],
    ['fileFppl', 'fileFpplOriginalPath'],
  ];
