...
const ROOTS = {
  ...
  fppl: [path.join(process.cwd(), 'public', 'fppl')],
  payment: [path.join(process.cwd(), 'uploads', 'bukti-bayar')],
};
...
const PREFIXES = {
  ...
  fppl: ['fppl/', '/fppl/'],
  payment: ['uploads/bukti-bayar/', '/uploads/bukti-bayar/', 'bukti-bayar/', '/bukti-bayar/'],
};
